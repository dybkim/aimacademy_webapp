        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <form:form action="${pageContext.request.contextPath}/admin/employee/addEmployee" method="POST" modelAttribute="employee">
                ...
                <div class="form-group"><form:errors path="employeeFirstName" cssStyle="color: #FF0000"/>
                    ...
                    <form:input path="employeeFirstName" id="employeeFirstName" class="form-Control" cssStyle="width: 400px"/>
                </div>

                <div class="form-group"><form:errors path="employeeLastName" cssStyle="color: #FF0000"/>
                    <label for="employeeLastName">Last Name</label>
                    <form:input path="employeeLastName" id="employeeLastName" class="form-Control" cssStyle="width: 400px"/>
                </div>

                <div class="form-group">
                    <label for="jobDescription">Job Description</label>
                    <form:select path="jobDescription" id="jobDescription" class="form-Control" cssStyle="width: 200px">
                ...
                <div class="form-group">
                    ...
                    <form:input path="dateEmployed" id="startDate" class="date"/>
                </div>
